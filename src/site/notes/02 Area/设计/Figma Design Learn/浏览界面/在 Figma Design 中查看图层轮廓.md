...
- Mac：<kbd>⌘ Command</kbd> <kbd>⇧Shift</kbd> <kbd>O</kbd>
- Windows：<kbd>Control</kbd> <kbd>⇧Shift</kbd> <kbd>O</kbd>

**Note**：若你更喜欢使用<kbd>⇧Shift</kbd> <kbd>O</kbd>来切换显示轮廓，请打开左上角的主菜单，进入偏好设置 > 使用旧的轮廓快捷键。此设置还将更改[轮廓描边](https://help.figma.com/hc/en-us/articles/360049283914-Apply-and-adjust-stroke-properties#outline-stroke)的键盘快捷键为 <kbd>⌘Command</kbd> / <kbd>Control</kbd> <kbd>⇧Shift</kbd> <kbd>O</kbd> 。

[[02 Area/设计/Figma Design Learn/创建设计/切换可见性以隐藏图层\|学习如何切换图层可见性 →]]
