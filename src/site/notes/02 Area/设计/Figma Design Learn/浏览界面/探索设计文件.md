...
开发模式允许你识别准备就绪的设计，并访问将设计转化为代码所需的信息。[[02 Area/设计/Figma Design Learn/开发模式指南\|开发模式指南 →]]
...
要浏览文件的页面，点击左侧边栏中的当前页面名称。你也可以点击创建一个新页面。[[02 Area/设计/Figma Design Learn/浏览界面/在左侧边栏查看图层和页面\|在侧边栏中查看页面 →]]
...
如果你正在作为交接过程的一部分查看文件，那么 Dev Mode 适合你。Dev Mode 是一个面向开发者的界面，用于检查和导航设计文件。[[02 Area/设计/Figma Design Learn/开发模式指南\|Dev Mode 指南→]]
