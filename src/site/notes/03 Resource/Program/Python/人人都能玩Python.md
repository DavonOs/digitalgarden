...
[[03 Resource/Program/Python/变量和简单数据类型\|变量和简单数据类型]]

[[03 Resource/Program/Python/列表的使用\|列表的使用]]
...
[[03 Resource/Program/Python/列表的使用\|< Prev]] | [[03 Resource/Program/Python/变量和简单数据类型\|Next >]]
