...
因此，阅读和写作是不可分割的活动。它们属于使事物有意义的持续努力，你可以通过它阅读你的方式；通过记下你的阅读记录，你制作了一本印有你的个性，属于你自己的书。

## 什么是第二大脑？

由个人独特视角解释形成的一个个离散的信息单元（知识积木）组成，作为数字化的专业笔记储存在你的头脑之外自己的“知识库”。可以将其视为学习笔记本、个人日记和新想法速写本的结合。可以在所有设备上快速搜索、移动、组织和同步，并重新组装成新的形式。

长度和格式无关紧要——如果一段内容已经通过你的视角进行了解读，根据你的品味进行了整理，翻译成你自己的文字，或者从你的生活经历中汲取灵感，并存储在一个安全的地方，那么它就是合格的笔记。
## 第二大脑的基本功能

- 想法具体化：让模糊的概念可以观察、重新排列、编辑和组合在一起的有形实体。
- 揭示想法间的新联系：承担一项任务，最具创造性、创新性的方法会立即成为首要考虑因素的机会有多大？前进的最佳方式是我们首先提出的方法之一的几率有多大？

	「近因偏差」：我们倾向于赞成最近发生在我们身上的想法、解决方案和影响，无论它们是否是最好的。

- 长期孵化想法：可长期永久保存大量想法的第二大脑，将时间的流逝变成你的朋友，而不是敌人。你能摆脱当下的束缚，并利用数周、数月甚至数年积累的想象力。用一种更平静、更可持续的创造力方法，依赖于想法的逐渐积累，而不是狂躁的喧嚣。

- 锐化独特观点：让自己的想法大放异彩是最终目的。倡导特定观点不仅是魅力的问题，它需要辅助材料。未来最可能留下的工作是那些涉及促进或捍卫特定观点的工作。我们的职业和企业比以往任何时候都更依赖于我们提出特定观点并说服他人采纳它的能力。
...
组织的最大诱惑之一就是过于完美主义，将组织过程本身视为目的。秩序本身就有某种令人满意的东西，很容易就此打住，而不是继续发展和分享我们的知识。需要始终保持警惕，以免积累如此多的信息，以至于将所有时间都花在管理这些信息上，而不是用于外部世界。
...
不要根据~~想法的来源~~来组织想法，而是根据<u>它们的去向</u>来组织它们——特别是它们可以帮助你实现的结果。
...
笔记是用来使用，而不仅仅是收集。需要进一步提炼把最初的捕捉转化为真正有价值的知识资产
...
当你向另一个人提出一个想法时，他们的反应本质上是不可预测的。他们通常会对你认为非常迷人的方面完全不感兴趣；它们不一定是对的或错的，但你可以以任何一种方式使用该反馈。反过来也可能发生。你可能认为某些事情是显而易见的，而他们却发现它令人兴奋。这也是有用的反馈。其他人可能会指出你从未考虑过的想法的各个方面，建议查看你从未知道的资源，或者贡献自己的想法以使其变得更好。所有这些形式的反馈都是利用你的第一和第二大脑，以及其他人的大脑的方式。
...
可链接到更详细的内容——你可以链接到你自己的私人笔记和网络上的公共资源，而不是试图把最后一点都塞到同一页上，这有助于避免大纲中包含太多细节。

交互式和多媒体的——不仅可以添加文本，还可以添加图像、GIF、视频、附件、图表、复选框等。

可搜索的——即使它很长，你也可以使用强大的搜索功能立即调出你要查找的任何术语。

可以从任何地方访问和编辑——通过同步到你的每台设备，可以从任何地方查看、编辑和添加。
...
创造力的悖论
没有来自客户、同事、合作者或朋友的反馈，你怎么能知道将你的想法转向哪个方向？不知道自己应该创造什么，如何在不向他们展示具体内容的情况下收集反馈？
...
我鼓励你使用我的启动清单作为起点，并随着时间的推移对其进行自定义，因为你了解它如何适合你自己的环境。根据你的职业或行业，你可能需要或多或少的正式手续、第一版时间以及参与人员。

以下是你可能希望包含在你自己的版本中的一些其他操作选项：

回答事前问题： 
你想学什么？最大的不确定性来源或你想回答的最重要的问题是什么？什么最有可能失败？

与利益相关者沟通：
向你的经理、同事、客户、顾客、股东、承包商等解释，项目的意义是什么及其重要性。

定义成功标准：
这个项目需要发生什么才能被认为是成功的？你需要达到的最低结果是什么，或者你正在努力争取的“延伸目标”是什么？

正式启动：
安排签到电话，制定预算和时间表，并写下目标和目标，以确保每个人都了解情况、保持一致并清楚对他们的期望。我发现正式启动很有用，即使它是一个单独的项目！
...
在任务管理器或项目管理应用程序中将项目标记为完成。
划掉相关的项目目标并移至“已完成”部分。
查看中间包并将它们移动到其他文件夹。
将项目移动到跨所有平台的存档。
如果项目变为非活动状态： 在存档前将当前状态笔记添加到项目文件夹。
...
1. 如果项目变为非活动状态：在存档前将当前状态笔记添加到项目文件夹。
...
与利益相关者沟通：通知你的经理、同事、客户、客户、股东、承包商等项目已完成以及结果如何。
...
### 回顾习惯（周回顾和月回顾）：
为什么你应该批量处理你的笔记（以及多久一次）定期回顾你的工作和生活，并决定是否要改变什么。

《Getting Things Done》作者大卫·艾伦，将每周回顾描述为定期检查，每周进行一次，你有意识地重新设置和回顾你的工作和生活。艾伦建议使用每周回顾来写下任何新的待办事项，回顾你的活动项目，并决定下一周的优先事项。

我建议再添加一个步骤：查看你在过去一周创建的笔记，给它们起一个简洁的标题，告诉你里面有什么，然后将它们分类到适当的 PARA 文件夹中。大多数笔记应用程序都有某种“收件箱”，用于收集新笔记，直到它们准备好接受审阅。这种“批处理”每个笔记只需要几秒钟，你可以在几分钟内完成。
...
在第 1 章中，我讲述了我无法解释的医疗状况的故事，以及它如何导致我开始以数字方式组织信息。

在那段旅程的几年里，我处于最低谷。我似乎已经用尽了现代医学能为我提供的所有途径。医生建议这一定是我脑子里的全部，因为他们的诊断没有发现任何问题。我比以往任何时候都更痛苦，醒来时脖子非常紧张，感觉就像一个老虎钳掐住了我的喉咙。

我开始退出我的朋友和社交圈，因为我被我所经历的痛苦所吞噬。我的注意力如此集中在我身体的疼痛上，以至于我发现很难进行对话。我开始花越来越多的时间独自一人上网，在那里我可以在没有语言的情况下进行交流和联系。当我慢慢陷入抑郁和绝望时，我对生活的看法变得黯淡。有一段时间，我感觉自己没有未来。我怎么能在不说话的情况下约会或交朋友呢？我能忍受不可预测的慢性疼痛吗？当我的症状继续恶化，没有任何治疗甚至诊断时，我可以期待什么样的未来？

大约在这个时候，我有两件事改变了我的生活，并挽救了我的生活。首先是冥想和正念。我开始冥想，发现了一个我从来不知道存在的灵性和内省的整个领域。令我惊讶的是，我发现我不是我的思想。我的想法是我潜意识中不断的背景喋喋不休，我可以选择是否“相信”它们
都在告诉我。冥想比医生开的任何东西都更能缓解我的症状。我的痛苦成为我的老师，向我展示需要我关注的事情。

我开始在冥想中拥有深刻、深刻的感人体验，我想与他人分享我所学到的东西。这让我有了第二个伟大的发现：在公共场合写作。我开始写博客，我的第一篇博文是关于我在北加州的内观禅修静修所的经历。我仍然难以说话，所以写作成了我的避难所。在我的博客上，我可以分享任何我想分享的东西，只要我想分享多少就有多详细。我掌控着自己，表达自己的能力没有限制。
通过那次经历，我发现了一些东西：自我表达是一种人类的基本需求。自我表达对我们的生存与食物或住所一样重要。我们必须能够分享我们的生活故事——从今天在学校发生的小事到我们关于生活的最宏大理论。
...
有了 Second Brain 的力量，你可以做任何你想做的事。一切都只是信息，你是将其流动和塑造成你想要的任何未来的大师。

### 最后的思考 你能做到

打造 "第二大脑 "没有唯一正确的方法。你的系统在别人看来可能是混乱的，但如果它能给你带来进步和快乐，那它就是正确的。
...
在你开始你的旅程时，这里有十二个你现在就可以采取的实用步骤，让你的 “第二大脑 ”开始运转。
...
我写这本书是为了给你一种新的方式来思考与你有关的知识。本书旨在为每个人提供一个创建并受益于第二大脑的途径，并介绍了个人知识管理的迷人世界。

这种练习始于记事，终于记事--包括捕捉、组织、提炼和表达信息、想法和工作包。CODE章节中的具体技巧是入门的最佳途径。然而，我收到的最常见问题之一是关于标记的高级技巧。

我编写了一个额外的章节，介绍如何按照可操作性原则为您的第二大脑创建一个标签系统。虽然标签并不是入门的必要条件，但它确实提供了一个额外的组织层，当您的知识收集增长时，它可能是有用的。
...
[打造第二大脑-浮生梦幻](https://alwaysgoodtime.space/2023/03/16/%E6%89%93%E9%80%A0%E7%AC%AC%E4%BA%8C%E5%A4%A7%E8%84%91/)