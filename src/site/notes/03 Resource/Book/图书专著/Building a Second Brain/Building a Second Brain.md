...
<div style="display: flex; gap: 25px; align-items: flex-start;padding: 20px; border-radius: 12px;background-color: var(--background-primary);box-shadow: var(--shadow-m);"><span></span><div style="flex: 0 0 180px; position: relative;"><span></span><img src="https://m.media-amazon.com/images/I/61PxZdCkHAL._SL1500_.jpg" style="width: 100%; border-radius: 6px;box-shadow: var(--shadow-l);border: 1px solid var(--background-modifier-border);" alt="Building a Second Brain"><div style="position: absolute; bottom: -10px; left: 50%; transform: translateX(-50%);background: var(--color-green);color: var(--text-on-accent); padding: 4px 12px;border-radius: 20px; font-size: 0.8em; font-weight: bold;white-space: nowrap; box-shadow: var(--shadow-s); z-index: 1;"><span>📖 已读</span></div></div><div style="flex: 1; min-width: 0;"><span></span><div style="margin-bottom: 0;"><span></span><h1 style="font-size: 1.8rem; font-weight: 800;margin: 0 0 5px 0;color: var(--text-title);"><span></span><a href="https://book.douban.com/subject/35761116/" target="_blank" style="color: inherit; text-decoration: none;border-bottom: 2px solid var(--color-blue);"><span>Building a Second Brain</span></a></h1><div style="font-size: 1.1rem;color: var(--text-muted);font-weight: 500;line-height: 1.4;margin-top: 0;margin-bottom: 0;"><span>A Proven Method to Organize Your Digital Life and Unlock Your Creative Potential</span></div></div><div style="width: 100%;margin-top: 15px;display: flex;flex-direction: column;gap: 8px;"><span></span><div style="display: flex;align-items: flex-start;"><span></span><div style="width: 30%;color: var(--text-normal);font-weight: 500;font-size: 0.92em;opacity: 0.85;"><span>✍️ 作者</span></div><div style="flex: 1;font-weight: 500;color: var(--text-normal);"><span>Tiago·Forte</span></div></div><div style="display: flex;align-items: flex-start;"><span></span><div style="width: 30%;color: var(--text-normal);font-weight: 500;font-size: 0.92em;opacity: 0.85;"><span>📚 分类</span></div><div style="flex: 1;font-weight: 500;color: var(--text-normal);"><span>B哲学宗教/B80思维科学</span></div></div><div style="display: flex;align-items: flex-start;"><span></span><div style="width: 30%;color: var(--text-normal);font-weight: 500;font-size: 0.92em;opacity: 0.85;"><span>📅 出版日期</span></div><div style="flex: 1;font-weight: 500;color: var(--text-normal);"><span>2022</span></div></div><div style="display: flex;align-items: flex-start;"><span></span><div style="width: 30%;color: var(--text-normal);font-weight: 500;font-size: 0.92em;opacity: 0.85;"><span>🌐 语言</span></div><div style="flex: 1;font-weight: 500;color: var(--text-normal);"><span>英 EN (关联版本: <a data-href="打造第二大脑" href="打造第二大脑" class="internal-link" target="_blank" rel="noopener nofollow">打造第二大脑</a>)</span></div></div><div style="display: flex;align-items: flex-start;"><span></span><div style="width: 30%;color: var(--text-normal);font-weight: 500;font-size: 0.92em;opacity: 0.85;"><span>🧲 资源</span></div><div style="flex: 1;font-weight: 500;color: var(--text-normal);"><span><a rel="noopener nofollow" class="external-link" href="https://alwaysgoodtime.space" target="_blank">https://alwaysgoodtime.space</a></span></div></div><div style="display: flex;align-items: flex-start;"><span></span><div style="width: 30%;color: var(--text-normal);font-weight: 500;font-size: 0.92em;opacity: 0.85;"><span>⭐ 评分</span></div><div style="flex: 1;font-weight: 500;color: var(--text-normal);font-weight: 600; color: var(--text-title);"><span>8.1 ★★★★☆</span></div></div></div></div></div>
