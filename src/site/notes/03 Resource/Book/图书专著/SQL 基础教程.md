---
{"dg-publish":true,"dg-permalink":"books/27055712","permalink":"/books/27055712/","title":"SQL 基础教程（第2版）","metatags":{"description":"本书是畅销书《SQL 基础教程》第 2 版，介绍了关系数据库以及用来操作关系数据库的 SQL 语言的使用方法。书中通过丰富的图示、大量示例程序和详实的操作步骤说明，让读者循序渐进地掌握 SQL 的基础知识和使用技巧，切实提高编程能力。每章结尾设置有练习题，帮助读者检验对各章内容的理解程度。另外，本书还将重要知识点总结为“法则”，方便读者随时查阅。第 2 版除了将示例程序更新为对应新版本的 DB 的 SQL 之外，还新增了一章，介绍如何从应用程序执行 SQL。本书适合数据库和 SQL 语言的初学者阅读，也可作为大中专院校的教材及企业新人培训用书。","og:site_name":"DavonOs","og:title":"SQL 基础教程（第2版）","og:type":"book","og:url":"https://zuji.eu.org/books/27055712","og:image":"https://file.ituring.com.cn/LargeCover/1712477631b07b9f5895","og:image:width":"50","og:image:alt":"bookcover"},"tags":["program/sql"],"dg-note-properties":{"title":"SQL 基础教程（第2版）","subTitle":"ゼロからはじめるデータベース操作","originalTitle":"SQL 第 2 版 ゼロからはじめるデータベース操作","author":"日/MICK","translator":["孙淼","罗勇"],"myState":null,"datePublished":"2017-06-01","yearPublished":2017,"totalPage":336,"score":9.1,"scoreStar":"★★★★☆","cover":"https://file.ituring.com.cn/LargeCover/1712477631b07b9f5895","url":"https://book.douban.com/subject/27055712/","ISBN":9787115455024,"series":"图灵程序设计丛书·数据库系列","publisher":"人民邮电出版社","edition":{"version":"2nd","language":"zh-Hans","related":null},"resource":null,"categories":"T工业技术/TP自动化技术、计算机技术/TP311.138","tags":"program/sql"}}
---
...
## [[第0章 绪论——搭建 SQL 的学习环境\|第0章 绪论——搭建 SQL 的学习环境]]
...
- 关联子查询也是用来对集合进行切分的
- 结合条件一定要写在子查询中
## [[第6章 函数、谓词、CASE表达式\|第6章 函数、谓词、CASE表达式]]
...
## [[第9章 通过应用程序连接数据库\|第9章 通过应用程序连接数据库]]
